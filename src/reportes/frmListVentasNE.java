...
public class frmListVentasNE extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(stinventario.STInventarioApp.class).getContext().getResourceMap(frmListVentasNE.class);
...
private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
    ...
    public void buscar_informacion()
    {
        ...
        if(this.chkFechaRegistro.isSelected())
        {
            ...
            ArrayList<clsCabecera> dataCompras = objCabecera.consultaDataVentasRangoRegistroNE(fechaInicio, fechaFin, soloCredito); 
            llenarData(dataCompras);
        }       
        else
        {
            ArrayList<clsCabecera> dataCompras = objCabecera.consultaDataVentasNE(soloCredito); 
            llenarData(dataCompras);    
        }
    }        
