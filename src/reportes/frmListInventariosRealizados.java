...
public class frmListInventariosRealizados extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(stinventario.STInventarioApp.class).getContext().getResourceMap(frmListInventariosRealizados.class);
...
private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
     ...
     public void llenarData(ArrayList<clsCabecera> dataCabecera)
    {
        ...
        {                    
            Object[] nuevaFila = {  i+1,        
                                    ...
                                    dataCabecera.get(i).getFecha(),
                                    dataCabecera.get(i).getComentario(),                                    
                                    dataCabecera.get(i).getDescuento(),    
                                    dataCabecera.get(i).getIVA(),
                                    dataCabecera.get(i).getTarifaCero(),
                                    dataCabecera.get(i).getTarifaCero1(),
                                    dataCabecera.get(i).getDescuento1(),
                                    dataCabecera.get(i).getNameCompleto()
             };       
             //total = total + dataCabecera.get(i).getTotal();
             totalEfectivo = totalEfectivo + dataCabecera.get(i).getDescuento1();
    ...
    public void buscar_informacion()
    {
        ...
        if(this.chkFechaRegistro.isSelected())
        {
            ...
            ArrayList<clsCabecera> dataCompras = objCabecera.consultaInventariosRealizadosFecha(fechaInicio, fechaFin); 
            llenarData(dataCompras);
        }       
        else
        {
            ArrayList<clsCabecera> dataCompras = objCabecera.consultaInventariosRealizados(); 
            llenarData(dataCompras);    
        }
    }        
...
private void tblDataMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblDataMouseClicked
    ...
    String idInventario = ""+tblData.getValueAt(fila,1);
    String fecha = "";
    String fechaInicio = "";
    String fechaFin = "";
    ...
    frmInventarioView formulario = new frmInventarioView(idInventario);
