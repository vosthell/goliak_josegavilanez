 ...
 * @author CKaiser
 */
public class frmListInvSeccionDetalle extends javax.swing.JInternalFrame {
    ...
    public frmListInvSeccionDetalle(String idGrupo, String nombreGrupo, String fecha, String fechaInicio, String fechaFin) {
        initComponents();
        
        dtmData.addColumn("N°");       
        dtmData.addColumn("CODIGO INV");
        dtmData.addColumn("CODIGO PRODUCTO");
        ...
        lblGrupo.setText(idGrupo + "-" + nombreGrupo);
        ...
        if(fecha.equals("NO"))
        {
            lblFecha.setText("SIN RANGO DE FECHA");
            ArrayList<clsDetalle> dataCompras = objDetalle.consultaInvGruposDetalle(idGrupo);
            llenarData(dataCompras);              
        } 
        else
        {
            lblFecha.setText("DESDE: " + fechaInicio + ", HASTA: " + fechaFin);
            ArrayList<clsDetalle> dataCompras = objDetalle.consultaInvGruposDetalleFecha(idGrupo, fechaInicio, fechaFin);
            llenarData(dataCompras);             
        }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(stinventario.STInventarioApp.class).getContext().getResourceMap(frmListInvSeccionDetalle.class);
        ...
        lblGrupo.setText(resourceMap.getString("lblGrupo.text")); // NOI18N
        lblGrupo.setName("lblGrupo"); // NOI18N
    ...
    public void llenarData(ArrayList<clsDetalle> dataCabecera)
    {
        ...
        {                    
            Object[] nuevaFila = {  i+1,        
                                    ...
                                    dataCabecera.get(i).getCodigoProducto(),
