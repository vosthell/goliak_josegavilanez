 ...
 * @author CKaiser
 */
public class frmListVentas extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(stinventario.STInventarioApp.class).getContext().getResourceMap(frmListVentas.class);
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addComponent(txtCredito, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 98, Short.MAX_VALUE)))))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        .addGap(647, 647, 647)
...
private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
     ...
     public void llenarData(ArrayList<clsCabecera> dataCabecera)
    {
        ...
        for(int i=0; i<maxData; i++)
        {
            ...
            fecha_realizada = dataCabecera.get(i).getFecha().substring(0, 16);                     
    ...
    public void buscar_informacion()
    {
        ...
        if(this.chkFechaRegistro.isSelected())
        {
            ...
            ArrayList<clsCabecera> dataCompras = objCabecera.consultaDataVentasRangoRegistro(fechaInicio, fechaFin, soloCredito); 
            llenarData(dataCompras);
        }       
        else
        {
            ArrayList<clsCabecera> dataCompras = objCabecera.consultaDataVentas(soloCredito); 
            llenarData(dataCompras);    
        }
    }        
