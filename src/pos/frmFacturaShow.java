 ...
 * @author Kaiser
 */
public class frmFacturaShow extends javax.swing.JDialog {
    ...
    public frmFacturaShow(java.awt.Frame parent, boolean modal, String p_idCabecera) {
        super(parent, modal);
        initComponents();  
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(stinventario.STInventarioApp.class).getContext().getResourceMap(frmFacturaShow.class);
...
private void txtEfectivoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtEfectivoKeyReleased
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmFacturaShow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                frmFacturaShow dialog = new frmFacturaShow(new javax.swing.JFrame(), true, new String());
