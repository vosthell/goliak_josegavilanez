...
public class frmFacturero extends javax.swing.JInternalFrame {
    ...
    private void llenarDatosFactureros(String mostrarActivos, String mostrarTerminados)
    {
        ...
        ArrayList<clsFacturero> dataFacturero = objFacturero.consultaDataFacturero(mostrarActivos, mostrarTerminados, "F"); 
...
private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
    ...
    {
        exito = objFacturero.insertarRegistro(txtSecuenciaInicio.getText(), txtSecuenciaFin.getText(), "F");
        if (exito)
        {
