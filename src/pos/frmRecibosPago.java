 ...
 * @author CKaiser
 */
public class frmRecibosPago extends javax.swing.JInternalFrame {
    ...
    private void llenarDatosFactureros(String mostrarActivos, String mostrarTerminados)
    {
        ...
        ArrayList<clsFacturero> dataFacturero = objFacturero.consultaDataFacturero(mostrarActivos, mostrarTerminados, "R"); 
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(stinventario.STInventarioApp.class).getContext().getResourceMap(frmRecibosPago.class);
...
private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
    ...
    {
        exito = objFacturero.insertarRegistro(txtSecuenciaInicio.getText(), txtSecuenciaFin.getText(), "R");
        if (exito)
        {
