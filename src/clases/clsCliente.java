...
public class clsCliente {
    ...
    public boolean insertarRegistro(String cedula, String n1, String n2, String a1, 
            ...
            String credito, String prov, String termino, String recinto, String email, String nombre_completo)
    {       
        boolean exito;
        try
        {           
    ...
    public boolean modificarRegistro(int p_codigo, String p_cedula, 
            ...
            String p_terminos, String p_recinto, String p_credito, 
            String p_email, String p_nombre_completo)
    {
        boolean exito = false;
        try
        {           
